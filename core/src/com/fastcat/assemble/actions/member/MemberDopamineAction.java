    ...
    protected void updateAction() {
        if(duration == baseDuration) {
            ...
            for(int i = 0; i < cnt; i++) {
                ...
                if(b) ActionHandler.set(new GainBlockAction(TargetType.SELF, dopamine, true));
                else ActionHandler.set(new DamageAction(new DamageInfo(dopamine, DamageType.NORMAL), TargetType.RANDOM_ENEMY));
            }
            //todo block effect
        }
    }

 ...
 * @author mzechner */
public class TextureAtlasFilterLoader extends SynchronousAssetLoader<TextureAtlas, TextureAtlasFilterLoader.TextureAtlasParameter> {
	public TextureAtlasFilterLoader (FileHandleResolver resolver) {
		super(resolver);
	}

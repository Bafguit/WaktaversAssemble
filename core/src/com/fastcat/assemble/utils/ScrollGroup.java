 ...
 * @author mzechner
 * @author Nathan Sweet */
public class ScrollGroup extends WidgetGroup {
	...
	public ScrollGroup(@Null Actor widget) {
		this(widget, new ScrollPaneStyle());
	}

	/** @param widget May be null. */
	public ScrollGroup(@Null Actor widget, Skin skin) {
		this(widget, skin.get(ScrollPaneStyle.class));
	}

	/** @param widget May be null. */
	public ScrollGroup(@Null Actor widget, Skin skin, String styleName) {
		this(widget, skin.get(styleName, ScrollPaneStyle.class));
	}

	/** @param widget May be null. */
	public ScrollGroup(@Null Actor widget, ScrollPaneStyle style) {
	...
	protected void addCaptureListener () {
		addCaptureListener(new InputListener() {
			...
			public boolean touchDown (InputEvent event, float x, float y, int pointer, int button) {
				...
				if (getStage() != null) getStage().setScrollFocus(ScrollGroup.this);
		...
		return new ActorGestureListener() {
			...
			public void fling (InputEvent event, float x, float y, int button) {
				...
				if (velocityX != 0 || velocityY != 0) {
					...
					ScrollGroup.this.fling(flingTime, velocityX, velocityY);
				}
			}
	...
	/** The style for a scroll pane, see {@link ScrollGroup}.
	 * @author mzechner
	 * @author Nathan Sweet */
